...
<div class="app-cmp-wrapper">
    ...
    <div class="container">
      <ul class="payment_logos">
        <li class="white">Payments <br/>
          We Accept</li>
        <li><span><i class="fa fa-cc-mastercard fa-3x"></i></span></li>
        <li><span><i class="fa fa-cc-visa fa-3x"></i></span></li>
        <li><span><i class="fa fa-cc-stripe fa-3x"></i></span></li>
        <li><span><i class="fa fa-paypal fa-3x"></i></span></li>
      </ul>
      <ul class="payment_logos two">
        ...
        <li><img src="http://placehold.it/60x45" alt=""/></li>
        <li><img src="http://placehold.it/60x45" alt=""/></li>
        <li><img src="http://placehold.it/40x45" alt=""/></li>
        <li><img src="http://placehold.it/60x45" alt=""/></li>
  ...
  <div class="copyrights">
    <div class="container">
      <div class="one_half"><span>Copyright © 2019 algoRhythms Studios, Ltd. All rights reserved.</span></div>
